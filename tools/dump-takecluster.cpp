...
int main(int argc, char *argv[])
{
    ...
    if(argc != 7)
    {
       cout << "exe filename(with xs ys zs) natom nstep cn njump nevery" << endl;
       return 0;
    }
       ...
       if( istep%nevery != 0)
           ...
           for (int iatom=0; iatom<natom; iatom++)
           {
              ...
              for (int kk=0; kk<cn; kk++)
              {
                 ...
                 else if(pdir[kk].type==3)
                    fout << "CC " << pdir[kk].x << " " << pdir[kk].y <<  " " << pdir[kk].z << " " << pdir[kk].id << endl;
                 else if(pdir[kk].type==4)
                    fout << "DD " << pdir[kk].x << " " << pdir[kk].y <<  " " << pdir[kk].z << " " << pdir[kk].id << endl;
              }
           }
       }
    }
