...
*Little hisgory* The idea of cluster alignment was initiated by [Kai-Ming Ho](https://scholar.google.com/citations?user=cGlRoOAAAAAJ&hl=en) and [Cai-Zhuang Wang](https://scholar.google.com/citations?user=9r-VpcgAAAAJ&hl=en) at [Ames laboraty](https://www.ameslab.gov/). The first code of cluster-template alignment was written with Fortran by X.W. Fang *et al.* in 2009, published in Phys. Rev. B 82,184204(2010). Later, [Y. Sun](https://scholar.google.com/citations?user=91yBLrMAAAAJ&hl=en), [F. Zhang](https://scholar.google.com/citations?user=uL51e5oAAAAJ&hl=en) and Ames lab group added pairwise alignment method as published in Sun *et al.*, Sci. Rep. 6,23734 (2016). The code was rewrote in C++ in 2016 to improve the optimization algorithm and efficiencies. Now the codes are mainly maintained by Y. Sun (yangsun017@gmail.com).
